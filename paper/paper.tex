...
for the \verb|eval| function; and \verb|d| for the subdata structure.
...
subsumes course-of-value recursion.  The technique of sized types is
similar to our method in providing a type-based method for
termination~\cite{barthe04}.  This technique enriches datatypes with
abstract sizes, which must then be propagated through code, using
dependent types.  Our \verb|Subrec| does not require dependent types,
resulting in just polymorphically typed code for the examples we saw
