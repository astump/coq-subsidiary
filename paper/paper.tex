...
algebras to functors is the critical step enabling such examples. In
our Coq development, we show that Uustalu and Vene's scheme is
derivable from subsidiary recursion. Our method is also similar to the
