...
how the interface is actually implemented (Section~\ref{sec:deriv}),
including our definition of retractive-positive recursive types
(Section~\ref{sec:mu}).  We then cover the interface for subsidiary
induction (Section~\ref{sec:interfacei}), and give some example proofs
using it (Section~\ref{sec:examplesi}). We conclude with a discussion
